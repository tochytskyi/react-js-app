...
/***/ function(module, exports, __webpack_require__) {
	...
	$.get('https://api.github.com/users/tochytskyi', function (data) {
		ReactDOM.render(React.createElement('h1', null, data.login), app);
	});

	$.get('https://api.github.com/users/tochytskyi/repos', function (data) {
		ReactDOM.render(React.createElement('h2', null, data['html_url']), app);
	});
